...
export interface SharedIcon extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    Lucid: Schema.Attribute.String;
  };
}

export interface SharedListeText extends Struct.ComponentSchema {
  collectionName: 'components_shared_liste_texts';
  info: {
    displayName: 'Liste Text';
  };
  attributes: {
    Valeur: Schema.Attribute.Text;
  };
}
...
export interface SharedTools extends Struct.ComponentSchema {
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ComponentSchemas {
      ...
      'shared.liste-text': SharedListeText;
      'shared.media': SharedMedia;
      'shared.quote': SharedQuote;
      'shared.rich-text': SharedRichText;
      'shared.seo': SharedSeo;
      'shared.slider': SharedSlider;
      'shared.tools': SharedTools;
    }
  }
}
