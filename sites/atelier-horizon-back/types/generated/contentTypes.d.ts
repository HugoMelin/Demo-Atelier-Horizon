...
export interface ApiFaqFaq extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::faq.faq'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Question: Schema.Attribute.Component<'shared.fa-qs', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiInfoInfo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Valeur: Schema.Attribute.Text & Schema.Attribute.Required;
  };
}
...
export interface ApiMethodologyMethodology extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Description: Schema.Attribute.Blocks & Schema.Attribute.Required;
    Details: Schema.Attribute.Component<'shared.liste-text', true>;
    Icon: Schema.Attribute.Component<'shared.icon', false>;
    Livrable: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiPrincipePrincipe extends Struct.CollectionTypeSchema {
  collectionName: 'principes';
  info: {
    displayName: 'Principe';
    pluralName: 'principes';
    singularName: 'principe';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Benefits: Schema.Attribute.Component<'shared.liste-text', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Description: Schema.Attribute.Blocks & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    Mis_en_avant: Schema.Attribute.Boolean;
    Ordre: Schema.Attribute.Integer;
    Pour_qui: Schema.Attribute.Text;
    Prix: Schema.Attribute.String & Schema.Attribute.Required;
    Probleme: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiToolTool extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tool.tool'> &
      Schema.Attribute.Private;
    Outils: Schema.Attribute.Component<'shared.tools', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTrustReasonTrustReason extends Struct.CollectionTypeSchema {
  collectionName: 'trust_reasons';
  info: {
    displayName: 'TrustReason';
    pluralName: 'trust-reasons';
    singularName: 'trust-reason';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::principe.principe': ApiPrincipePrincipe;
      'api::service.service': ApiServiceService;
      'api::testimonial.testimonial': ApiTestimonialTestimonial;
      'api::tool.tool': ApiToolTool;
      'api::trust-reason.trust-reason': ApiTrustReasonTrustReason;
